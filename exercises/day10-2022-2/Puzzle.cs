internal class Puzzle(string rawInput) : AocPuzzle<string[], string>(rawInput)
{
    ...
    private void ExecuteLines() => _values = _input.Aggregate((List<int>)[1], ExecuteLine);
    ...
    private int GetSignalStrength(int cycle) => cycle * _values[cycle - 1];
